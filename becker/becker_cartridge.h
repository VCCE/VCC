...
namespace vcc::cartridges::becker_port
{
	...
	/// @brief Becker Port cartridge plugin.
	///
	/// This plugin provides an implementation of the Becker Port cartridge, access to the
	...
	public:
		...
		/// @brief Type alias for the component emulating the Becker Port serial hardware.
		using driver_type = ::vcc::cartridges::becker_port::becker_cartridge_driver;
	...
	protected:
		...
		/// @brief Retrieve the address of the DriveWire server the Becker driver will
		/// connect to.
		/// 
		/// @return A string containing the server address.
		string_type server_address_setting() const;

		/// @brief Retrieve the port of the DriveWire server the Becker driver will
		/// connect to.
		/// 
	...
	private:
		...
		struct configuration
		{
			...
			struct defaults
			{
				...
				static const inline string_type server_address = "127.0.0.1";
				/// @brief The default DriveWire server port to connect to.
				static const inline string_type server_port = "65504";
			};
		};
