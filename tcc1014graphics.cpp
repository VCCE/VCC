...
static unsigned char  PaletteLookup8[2][64];	//0 = RGB 1=comp 8BIT
static unsigned short PaletteLookup16[2][64];	//0 = RGB 1=comp 16BIT
static unsigned int   PaletteLookup32[2][64];	//0 = RGB 1=comp 32BIT
...
// 0 = composite
// 1 = rgb
int GimeGpu::Pmode4MonType() const
{
	...
	switch (MasterMode) // (GraphicsMode <<7) | (CompatMode<<6)  | ((Bpp & 3)<<4) | (Stretch & 15);
		{
			case 0: //Width 80
				...
				{									
					...
					TextPalette[1]=Palette8Bit[8+((Attributes & 56)>>3)];
					TextPalette[0]=Palette8Bit[Attributes & 7];
					US8State->PTRsurface8[YStride+=1]=TextPalette[Pixel >>7 ];
					US8State->PTRsurface8[YStride+=1]=TextPalette[(Pixel>>6)&1];
					US8State->PTRsurface8[YStride+=1]=TextPalette[(Pixel>>5)&1];
					US8State->PTRsurface8[YStride+=1]=TextPalette[(Pixel>>4)&1];
					US8State->PTRsurface8[YStride+=1]=TextPalette[(Pixel>>3)&1];
					US8State->PTRsurface8[YStride+=1]=TextPalette[(Pixel>>2)&1];
					US8State->PTRsurface8[YStride+=1]=TextPalette[(Pixel>>1)&1];
					US8State->PTRsurface8[YStride+=1]=TextPalette[Pixel&1];
					if (!US8State->ScanLines)
					{
						YStride-=8;
		...
		//	case 2:
			...
			case 63:
				...
				{									
					...
					TextPalette[1]=Palette8Bit[8+((Attributes & 56)>>3)];
					TextPalette[0]=Palette8Bit[Attributes & 7];
					US8State->PTRsurface8[YStride+=1]=TextPalette[(Pixel & 128)/128 ];
					US8State->PTRsurface8[YStride+=1]=TextPalette[(Pixel & 64)/64];
					US8State->PTRsurface8[YStride+=1]=TextPalette[(Pixel & 32)/32 ];
					US8State->PTRsurface8[YStride+=1]=TextPalette[(Pixel & 16)/16];
					US8State->PTRsurface8[YStride+=1]=TextPalette[(Pixel & 8)/8 ];
					US8State->PTRsurface8[YStride+=1]=TextPalette[(Pixel & 4)/4];
					US8State->PTRsurface8[YStride+=1]=TextPalette[(Pixel & 2)/2 ];
					US8State->PTRsurface8[YStride+=1]=TextPalette[Pixel & 1];
				} 
			break;
			...
			case 127:
				...
				{										
					...
					case 0:
						...
						TextPalette[0]=Palette8Bit[TextBGPalette];
						TextPalette[1]=Palette8Bit[TextFGPalette];
					...
					case 2:
					case 3:
						TextPalette[1] = Palette8Bit[(Character & 112) >> 4];
						TextPalette[0] = Palette8Bit[8];
...
case 128+0: //Bpp=0 Sr=0 1BPP Stretch=1
	for (HorzBeam=0;HorzBeam<BytesperRow;HorzBeam+=2) //1bbp Stretch=1
	{
		...
		US8State->PTRsurface8[YStride+=1]=Palette8Bit[ 1 & (WidePixel>>7)];
		US8State->PTRsurface8[YStride+=1]=Palette8Bit[ 1 & (WidePixel>>6)];
		US8State->PTRsurface8[YStride+=1]=Palette8Bit[ 1 & (WidePixel>>5)];
		US8State->PTRsurface8[YStride+=1]=Palette8Bit[ 1 & (WidePixel>>4)];
		US8State->PTRsurface8[YStride+=1]=Palette8Bit[ 1 & (WidePixel>>3)];
		US8State->PTRsurface8[YStride+=1]=Palette8Bit[ 1 & (WidePixel>>2)];
		US8State->PTRsurface8[YStride+=1]=Palette8Bit[ 1 & (WidePixel>>1)];
		US8State->PTRsurface8[YStride+=1]=Palette8Bit[ 1 & WidePixel];
		US8State->PTRsurface8[YStride+=1]=Palette8Bit[ 1 & (WidePixel>>15)];
		US8State->PTRsurface8[YStride+=1]=Palette8Bit[ 1 & (WidePixel>>14)];
		US8State->PTRsurface8[YStride+=1]=Palette8Bit[ 1 & (WidePixel>>13)];
		US8State->PTRsurface8[YStride+=1]=Palette8Bit[ 1 & (WidePixel>>12)];
		US8State->PTRsurface8[YStride+=1]=Palette8Bit[ 1 & (WidePixel>>11)];
		US8State->PTRsurface8[YStride+=1]=Palette8Bit[ 1 & (WidePixel>>10)];
		US8State->PTRsurface8[YStride+=1]=Palette8Bit[ 1 & (WidePixel>>9)];
		US8State->PTRsurface8[YStride+=1]=Palette8Bit[ 1 & (WidePixel>>8)];
		if (!US8State->ScanLines)
		{
			YStride-=16;
			YStride+=US8State->SurfacePitch;
...
case 128+16: //BPP=1 Sr=0  2BPP Stretch=1
	...
	{
		WidePixel=US8State->WRamBuffer[(VidMask & ( Start+(unsigned char)(Hoffset+HorzBeam) ))>>1];
		US8State->PTRsurface8[YStride+=1]=Palette8Bit[ 3 & (WidePixel>>6)];
		US8State->PTRsurface8[YStride+=1]=Palette8Bit[ 3 & (WidePixel>>4)];
		US8State->PTRsurface8[YStride+=1]=Palette8Bit[ 3 & (WidePixel>>2)];
		US8State->PTRsurface8[YStride+=1]=Palette8Bit[ 3 & WidePixel];
		US8State->PTRsurface8[YStride+=1]=Palette8Bit[ 3 & (WidePixel>>14)];
		US8State->PTRsurface8[YStride+=1]=Palette8Bit[ 3 & (WidePixel>>12)];
		US8State->PTRsurface8[YStride+=1]=Palette8Bit[ 3 & (WidePixel>>10)];
		US8State->PTRsurface8[YStride+=1]=Palette8Bit[ 3 & (WidePixel>>8)];
		if (!US8State->ScanLines)
		{
			YStride-=8;
			YStride+=US8State->SurfacePitch;
...
case 128+32: //Bpp=2 Sr=0 4BPP Stretch=1
	...
	{
		WidePixel=US8State->WRamBuffer[(VidMask & ( Start+(unsigned char)(Hoffset+HorzBeam) ))>>1];
		US8State->PTRsurface8[YStride+=1]=Palette8Bit[ 15 & (WidePixel>>4)];
		US8State->PTRsurface8[YStride+=1]=Palette8Bit[ 15 & WidePixel];
		US8State->PTRsurface8[YStride+=1]=Palette8Bit[ 15 & (WidePixel>>12)];
		US8State->PTRsurface8[YStride+=1]=Palette8Bit[ 15 & (WidePixel>>8)];
		if (!US8State->ScanLines)
		{
			YStride-=4;
			YStride+=US8State->SurfacePitch;
...
case 192+0: //Bpp=0 Sr=0 1BPP Stretch=1
	...
	{
		WidePixel=US8State->WRamBuffer[(VidMask & ( Start+(unsigned char)(Hoffset+HorzBeam) ))>>1];
		US8State->PTRsurface8[YStride+=1]=Palette8Bit[PaletteIndex+( 1 & (WidePixel>>7))];
		US8State->PTRsurface8[YStride+=1]=Palette8Bit[PaletteIndex+( 1 & (WidePixel>>6))];
		US8State->PTRsurface8[YStride+=1]=Palette8Bit[PaletteIndex+( 1 & (WidePixel>>5))];
		US8State->PTRsurface8[YStride+=1]=Palette8Bit[PaletteIndex+( 1 & (WidePixel>>4))];
		US8State->PTRsurface8[YStride+=1]=Palette8Bit[PaletteIndex+( 1 & (WidePixel>>3))];
		US8State->PTRsurface8[YStride+=1]=Palette8Bit[PaletteIndex+( 1 & (WidePixel>>2))];
		US8State->PTRsurface8[YStride+=1]=Palette8Bit[PaletteIndex+( 1 & (WidePixel>>1))];
		US8State->PTRsurface8[YStride+=1]=Palette8Bit[PaletteIndex+( 1 & WidePixel)];
		US8State->PTRsurface8[YStride+=1]=Palette8Bit[PaletteIndex+( 1 & (WidePixel>>15))];
		US8State->PTRsurface8[YStride+=1]=Palette8Bit[PaletteIndex+( 1 & (WidePixel>>14))];
		US8State->PTRsurface8[YStride+=1]=Palette8Bit[PaletteIndex+( 1 & (WidePixel>>13))];
		US8State->PTRsurface8[YStride+=1]=Palette8Bit[PaletteIndex+( 1 & (WidePixel>>12))];
		US8State->PTRsurface8[YStride+=1]=Palette8Bit[PaletteIndex+( 1 & (WidePixel>>11))];
		US8State->PTRsurface8[YStride+=1]=Palette8Bit[PaletteIndex+( 1 & (WidePixel>>10))];
		US8State->PTRsurface8[YStride+=1]=Palette8Bit[PaletteIndex+( 1 & (WidePixel>>9))];
		US8State->PTRsurface8[YStride+=1]=Palette8Bit[PaletteIndex+( 1 & (WidePixel>>8))];
		if (!US8State->ScanLines)
		{
			YStride-=16;
			YStride+=US8State->SurfacePitch;
...
case 192+16: //BPP=1 Sr=0  2BPP Stretch=1
	...
	{
		WidePixel=US8State->WRamBuffer[(VidMask & ( Start+(unsigned char)(Hoffset+HorzBeam) ))>>1];
		US8State->PTRsurface8[YStride+=1]=Palette8Bit[PaletteIndex+( 3 & (WidePixel>>6))];
		US8State->PTRsurface8[YStride+=1]=Palette8Bit[PaletteIndex+( 3 & (WidePixel>>4))];
		US8State->PTRsurface8[YStride+=1]=Palette8Bit[PaletteIndex+( 3 & (WidePixel>>2))];
		US8State->PTRsurface8[YStride+=1]=Palette8Bit[PaletteIndex+( 3 & WidePixel)];
		US8State->PTRsurface8[YStride+=1]=Palette8Bit[PaletteIndex+( 3 & (WidePixel>>14))];
		US8State->PTRsurface8[YStride+=1]=Palette8Bit[PaletteIndex+( 3 & (WidePixel>>12))];
		US8State->PTRsurface8[YStride+=1]=Palette8Bit[PaletteIndex+( 3 & (WidePixel>>10))];
		US8State->PTRsurface8[YStride+=1]=Palette8Bit[PaletteIndex+( 3 & (WidePixel>>8))];
		if (!US8State->ScanLines)
		{
			YStride-=8;
			YStride+=US8State->SurfacePitch;
	...
	switch (MasterMode) // (GraphicsMode <<7) | (CompatMode<<6)  | ((Bpp & 3)<<4) | (Stretch & 15);
		{
			case 0: //Width 80
				...
				{									
					...
					TextPalette[1]=Palette16Bit[8+((Attributes & 56)>>3)];
					TextPalette[0]=Palette16Bit[Attributes & 7];
					USState16->PTRsurface16[YStride+=1]=TextPalette[Pixel >>7 ];
					USState16->PTRsurface16[YStride+=1]=TextPalette[(Pixel>>6)&1];
					USState16->PTRsurface16[YStride+=1]=TextPalette[(Pixel>>5)&1];
					USState16->PTRsurface16[YStride+=1]=TextPalette[(Pixel>>4)&1];
					USState16->PTRsurface16[YStride+=1]=TextPalette[(Pixel>>3)&1];
					USState16->PTRsurface16[YStride+=1]=TextPalette[(Pixel>>2)&1];
					USState16->PTRsurface16[YStride+=1]=TextPalette[(Pixel>>1)&1];
					USState16->PTRsurface16[YStride+=1]=TextPalette[Pixel&1];
					if (!USState16->ScanLines)
					{
						YStride-=8;
		...
		//	case 2:
			...
			case 63:
				...
				{									
					...
					TextPalette[1]=Palette16Bit[8+((Attributes & 56)>>3)];
					TextPalette[0]=Palette16Bit[Attributes & 7];
					USState16->PTRsurface16[YStride+=1]=TextPalette[(Pixel & 128)/128 ];
					USState16->PTRsurface16[YStride+=1]=TextPalette[(Pixel & 64)/64];
					USState16->PTRsurface16[YStride+=1]=TextPalette[(Pixel & 32)/32 ];
					USState16->PTRsurface16[YStride+=1]=TextPalette[(Pixel & 16)/16];
					USState16->PTRsurface16[YStride+=1]=TextPalette[(Pixel & 8)/8 ];
					USState16->PTRsurface16[YStride+=1]=TextPalette[(Pixel & 4)/4];
					USState16->PTRsurface16[YStride+=1]=TextPalette[(Pixel & 2)/2 ];
					USState16->PTRsurface16[YStride+=1]=TextPalette[Pixel & 1];
				} 
			break;
...
//******************************************************************** Low Res Text
			...
			case 127:
				...
				{										
					...
					case 0:
						Character = Character & 63;
						TextPalette[0]=Palette16Bit[TextBGPalette];
						TextPalette[1]=Palette16Bit[TextFGPalette];
						if (LowerCase && (Character < 32))
					...
					case 2:
					case 3:
						TextPalette[1] = Palette16Bit[(Character & 112) >> 4];
						TextPalette[0] = Palette16Bit[8];
						Character = 64 + (Character & 0xF);
						Pixel=ntsc_round_fontdata8x12[Character*12+ (USState16->LineCounter%12)];
					break;
...
case 128+0: //Bpp=0 Sr=0 1BPP Stretch=1
	...
	for (HorzBeam=0;HorzBeam<BytesperRow;HorzBeam+=2) //1bbp Stretch=1
	{
		...
		USState16->PTRsurface16[YStride+=1]=Palette16Bit[ 1 & (WidePixel>>7)];
		USState16->PTRsurface16[YStride+=1]=Palette16Bit[ 1 & (WidePixel>>6)];
		USState16->PTRsurface16[YStride+=1]=Palette16Bit[ 1 & (WidePixel>>5)];
		USState16->PTRsurface16[YStride+=1]=Palette16Bit[ 1 & (WidePixel>>4)];
		USState16->PTRsurface16[YStride+=1]=Palette16Bit[ 1 & (WidePixel>>3)];
		USState16->PTRsurface16[YStride+=1]=Palette16Bit[ 1 & (WidePixel>>2)];
		USState16->PTRsurface16[YStride+=1]=Palette16Bit[ 1 & (WidePixel>>1)];
		USState16->PTRsurface16[YStride+=1]=Palette16Bit[ 1 & WidePixel];
		USState16->PTRsurface16[YStride+=1]=Palette16Bit[ 1 & (WidePixel>>15)];
		USState16->PTRsurface16[YStride+=1]=Palette16Bit[ 1 & (WidePixel>>14)];
		USState16->PTRsurface16[YStride+=1]=Palette16Bit[ 1 & (WidePixel>>13)];
		USState16->PTRsurface16[YStride+=1]=Palette16Bit[ 1 & (WidePixel>>12)];
		USState16->PTRsurface16[YStride+=1]=Palette16Bit[ 1 & (WidePixel>>11)];
		USState16->PTRsurface16[YStride+=1]=Palette16Bit[ 1 & (WidePixel>>10)];
		USState16->PTRsurface16[YStride+=1]=Palette16Bit[ 1 & (WidePixel>>9)];
		USState16->PTRsurface16[YStride+=1]=Palette16Bit[ 1 & (WidePixel>>8)];
		if (!USState16->ScanLines)
		{
			YStride-=16;
			YStride+=USState16->SurfacePitch;
...
case 128+16: //BPP=1 Sr=0  2BPP Stretch=1
	...
	{
		WidePixel=USState16->WRamBuffer[(VidMask & ( Start+(unsigned char)(Hoffset+HorzBeam) ))>>1];
		USState16->PTRsurface16[YStride+=1]=Palette16Bit[ 3 & (WidePixel>>6)];
		USState16->PTRsurface16[YStride+=1]=Palette16Bit[ 3 & (WidePixel>>4)];
		USState16->PTRsurface16[YStride+=1]=Palette16Bit[ 3 & (WidePixel>>2)];
		USState16->PTRsurface16[YStride+=1]=Palette16Bit[ 3 & WidePixel];
		USState16->PTRsurface16[YStride+=1]=Palette16Bit[ 3 & (WidePixel>>14)];
		USState16->PTRsurface16[YStride+=1]=Palette16Bit[ 3 & (WidePixel>>12)];
		USState16->PTRsurface16[YStride+=1]=Palette16Bit[ 3 & (WidePixel>>10)];
		USState16->PTRsurface16[YStride+=1]=Palette16Bit[ 3 & (WidePixel>>8)];
		if (!USState16->ScanLines)
		{
			YStride-=8;
			YStride+=USState16->SurfacePitch;
...
case 128+32: //Bpp=2 Sr=0 4BPP Stretch=1
	...
	{
		WidePixel=USState16->WRamBuffer[(VidMask & ( Start+(unsigned char)(Hoffset+HorzBeam) ))>>1];
		USState16->PTRsurface16[YStride+=1]=Palette16Bit[ 15 & (WidePixel>>4)];
		USState16->PTRsurface16[YStride+=1]=Palette16Bit[ 15 & WidePixel];
		USState16->PTRsurface16[YStride+=1]=Palette16Bit[ 15 & (WidePixel>>12)];
		USState16->PTRsurface16[YStride+=1]=Palette16Bit[ 15 & (WidePixel>>8)];
		if (!USState16->ScanLines)
		{
			YStride-=4;
			YStride+=USState16->SurfacePitch;
...
case 192+0: //Bpp=0 Sr=0 1BPP Stretch=1
	...
	{
		WidePixel=USState16->WRamBuffer[(VidMask & ( Start+(unsigned char)(Hoffset+HorzBeam) ))>>1];
		USState16->PTRsurface16[YStride+=1]=Palette16Bit[PaletteIndex+( 1 & (WidePixel>>7))];
		USState16->PTRsurface16[YStride+=1]=Palette16Bit[PaletteIndex+( 1 & (WidePixel>>6))];
		USState16->PTRsurface16[YStride+=1]=Palette16Bit[PaletteIndex+( 1 & (WidePixel>>5))];
		USState16->PTRsurface16[YStride+=1]=Palette16Bit[PaletteIndex+( 1 & (WidePixel>>4))];
		USState16->PTRsurface16[YStride+=1]=Palette16Bit[PaletteIndex+( 1 & (WidePixel>>3))];
		USState16->PTRsurface16[YStride+=1]=Palette16Bit[PaletteIndex+( 1 & (WidePixel>>2))];
		USState16->PTRsurface16[YStride+=1]=Palette16Bit[PaletteIndex+( 1 & (WidePixel>>1))];
		USState16->PTRsurface16[YStride+=1]=Palette16Bit[PaletteIndex+( 1 & WidePixel)];
		USState16->PTRsurface16[YStride+=1]=Palette16Bit[PaletteIndex+( 1 & (WidePixel>>15))];
		USState16->PTRsurface16[YStride+=1]=Palette16Bit[PaletteIndex+( 1 & (WidePixel>>14))];
		USState16->PTRsurface16[YStride+=1]=Palette16Bit[PaletteIndex+( 1 & (WidePixel>>13))];
		USState16->PTRsurface16[YStride+=1]=Palette16Bit[PaletteIndex+( 1 & (WidePixel>>12))];
		USState16->PTRsurface16[YStride+=1]=Palette16Bit[PaletteIndex+( 1 & (WidePixel>>11))];
		USState16->PTRsurface16[YStride+=1]=Palette16Bit[PaletteIndex+( 1 & (WidePixel>>10))];
		USState16->PTRsurface16[YStride+=1]=Palette16Bit[PaletteIndex+( 1 & (WidePixel>>9))];
		USState16->PTRsurface16[YStride+=1]=Palette16Bit[PaletteIndex+( 1 & (WidePixel>>8))];
		if (!USState16->ScanLines)
		{
			YStride-=16;
			YStride+=USState16->SurfacePitch;
...
case 192+16: //BPP=1 Sr=0  2BPP Stretch=1
	...
	{
		WidePixel=USState16->WRamBuffer[(VidMask & ( Start+(unsigned char)(Hoffset+HorzBeam) ))>>1];
		USState16->PTRsurface16[YStride+=1]=Palette16Bit[PaletteIndex+( 3 & (WidePixel>>6))];
		USState16->PTRsurface16[YStride+=1]=Palette16Bit[PaletteIndex+( 3 & (WidePixel>>4))];
		USState16->PTRsurface16[YStride+=1]=Palette16Bit[PaletteIndex+( 3 & (WidePixel>>2))];
		USState16->PTRsurface16[YStride+=1]=Palette16Bit[PaletteIndex+( 3 & WidePixel)];
		USState16->PTRsurface16[YStride+=1]=Palette16Bit[PaletteIndex+( 3 & (WidePixel>>14))];
		USState16->PTRsurface16[YStride+=1]=Palette16Bit[PaletteIndex+( 3 & (WidePixel>>12))];
		USState16->PTRsurface16[YStride+=1]=Palette16Bit[PaletteIndex+( 3 & (WidePixel>>10))];
		USState16->PTRsurface16[YStride+=1]=Palette16Bit[PaletteIndex+( 3 & (WidePixel>>8))];
		if (!USState16->ScanLines)
		{
			YStride-=8;
			YStride+=USState16->SurfacePitch;
...
void GimeGpu::UpdateScreen24(SystemState * /*USState24*/)
{
}
...
void GimeGpu::UpdateScreen32(SystemState* USState32)
{
	gGimeGpu.UpdateScreen32To(USState32->RamBuffer, USState32->PTRsurface32, USState32->LineCounter, USState32->SurfacePitch, USState32->ScanLines);
}
...
void GimeGpu::UpdateScreen32To(unsigned char *buffer, unsigned int *surface, int lineCounter, int surfacePitch, bool ScanLines)
{
	...
	unsigned short* WideBuffer = (unsigned short*)buffer;
	unsigned short WidePixel = 0;
	...
	char Pcolor = 0;
	Surface32 szSurface32(surface);
	unsigned short y = lineCounter;
	long Xpitch = surfacePitch;
	Carry1 = 1;
	Pcolor = 0;
	
	if (curr_gmode != last_gmode) {
		std::string tmpout = "Graphics mode switched to " + std::string(curr_gmode) +"\n";
	...
	switch (MasterMode) // (GraphicsMode <<7) | (CompatMode<<6)  | ((Bpp & 3)<<4) | (Stretch & 15);
		{
			case 0: //Width 80
				...
				{									
					...
					TextPalette[1]=Palette32Bit[8+((Attributes & 56)>>3)];
					TextPalette[0]=Palette32Bit[Attributes & 7];
...
//******************************************************************** Low Res Text
			...
			case 127:
				...
				{										
					...
					case 0:
						Character = Character & 63;
						TextPalette[0]=Palette32Bit[TextBGPalette];
						TextPalette[1]=Palette32Bit[TextFGPalette];
						if (LowerCase && (Character < 32))
					...
					case 2:
					case 3:
						TextPalette[1] = Palette32Bit[(Character & 112) >> 4];
						TextPalette[0] = Palette32Bit[8];
						Character = 64 + (Character & 0xF);
						Pixel=ntsc_round_fontdata8x12[Character*12+ (y%12)];
					break;
...
case 128+0: //Bpp=0 Sr=0 1BPP Stretch=1
	...
	for (HorzBeam=0;HorzBeam<BytesperRow;HorzBeam+=2) //1bbp Stretch=1
	{
		...
		szSurface32[YStride+=1]=Palette32Bit[ 1 & (WidePixel>>7)];
		szSurface32[YStride+=1]=Palette32Bit[ 1 & (WidePixel>>6)];
		szSurface32[YStride+=1]=Palette32Bit[ 1 & (WidePixel>>5)];
		szSurface32[YStride+=1]=Palette32Bit[ 1 & (WidePixel>>4)];
		szSurface32[YStride+=1]=Palette32Bit[ 1 & (WidePixel>>3)];
		szSurface32[YStride+=1]=Palette32Bit[ 1 & (WidePixel>>2)];
		szSurface32[YStride+=1]=Palette32Bit[ 1 & (WidePixel>>1)];
		szSurface32[YStride+=1]=Palette32Bit[ 1 & WidePixel];
		szSurface32[YStride+=1]=Palette32Bit[ 1 & (WidePixel>>15)];
		szSurface32[YStride+=1]=Palette32Bit[ 1 & (WidePixel>>14)];
		szSurface32[YStride+=1]=Palette32Bit[ 1 & (WidePixel>>13)];
		szSurface32[YStride+=1]=Palette32Bit[ 1 & (WidePixel>>12)];
		szSurface32[YStride+=1]=Palette32Bit[ 1 & (WidePixel>>11)];
		szSurface32[YStride+=1]=Palette32Bit[ 1 & (WidePixel>>10)];
		szSurface32[YStride+=1]=Palette32Bit[ 1 & (WidePixel>>9)];
		szSurface32[YStride+=1]=Palette32Bit[ 1 & (WidePixel>>8)];
		if (!ScanLines)
		{
			YStride-=16;
			YStride+=Xpitch;
...
case 128+16: //BPP=1 Sr=0  2BPP Stretch=1
	...
	{
		WidePixel=WideBuffer[(VidMask & ( Start+(unsigned char)(Hoffset+HorzBeam) ))>>1];
		szSurface32[YStride+=1]=Palette32Bit[ 3 & (WidePixel>>6)];
		szSurface32[YStride+=1]=Palette32Bit[ 3 & (WidePixel>>4)];
		szSurface32[YStride+=1]=Palette32Bit[ 3 & (WidePixel>>2)];
		szSurface32[YStride+=1]=Palette32Bit[ 3 & WidePixel];
		szSurface32[YStride+=1]=Palette32Bit[ 3 & (WidePixel>>14)];
		szSurface32[YStride+=1]=Palette32Bit[ 3 & (WidePixel>>12)];
		szSurface32[YStride+=1]=Palette32Bit[ 3 & (WidePixel>>10)];
		szSurface32[YStride+=1]=Palette32Bit[ 3 & (WidePixel>>8)];
		if (!ScanLines)
		{
			YStride-=8;
			YStride+=Xpitch;
...
case 128+32: //Bpp=2 Sr=0 4BPP Stretch=1
	...
	{
		WidePixel=WideBuffer[(VidMask & ( Start+(unsigned char)(Hoffset+HorzBeam) ))>>1];
		szSurface32[YStride+=1]=Palette32Bit[ 15 & (WidePixel>>4)];
		szSurface32[YStride+=1]=Palette32Bit[ 15 & WidePixel];
		szSurface32[YStride+=1]=Palette32Bit[ 15 & (WidePixel>>12)];
		szSurface32[YStride+=1]=Palette32Bit[ 15 & (WidePixel>>8)];
		if (!ScanLines)
		{
			YStride-=4;
			YStride+=Xpitch;
...
case 192+0: //Bpp=0 Sr=0 1BPP Stretch=1
	...
	{
		WidePixel=WideBuffer[(VidMask & ( Start+(unsigned char)(Hoffset+HorzBeam) ))>>1];
		szSurface32[YStride+=1]=Palette32Bit[PaletteIndex+( 1 & (WidePixel>>7))];
		szSurface32[YStride+=1]=Palette32Bit[PaletteIndex+( 1 & (WidePixel>>6))];
		szSurface32[YStride+=1]=Palette32Bit[PaletteIndex+( 1 & (WidePixel>>5))];
		szSurface32[YStride+=1]=Palette32Bit[PaletteIndex+( 1 & (WidePixel>>4))];
		szSurface32[YStride+=1]=Palette32Bit[PaletteIndex+( 1 & (WidePixel>>3))];
		szSurface32[YStride+=1]=Palette32Bit[PaletteIndex+( 1 & (WidePixel>>2))];
		szSurface32[YStride+=1]=Palette32Bit[PaletteIndex+( 1 & (WidePixel>>1))];
		szSurface32[YStride+=1]=Palette32Bit[PaletteIndex+( 1 & WidePixel)];
		szSurface32[YStride+=1]=Palette32Bit[PaletteIndex+( 1 & (WidePixel>>15))];
		szSurface32[YStride+=1]=Palette32Bit[PaletteIndex+( 1 & (WidePixel>>14))];
		szSurface32[YStride+=1]=Palette32Bit[PaletteIndex+( 1 & (WidePixel>>13))];
		szSurface32[YStride+=1]=Palette32Bit[PaletteIndex+( 1 & (WidePixel>>12))];
		szSurface32[YStride+=1]=Palette32Bit[PaletteIndex+( 1 & (WidePixel>>11))];
		szSurface32[YStride+=1]=Palette32Bit[PaletteIndex+( 1 & (WidePixel>>10))];
		szSurface32[YStride+=1]=Palette32Bit[PaletteIndex+( 1 & (WidePixel>>9))];
		szSurface32[YStride+=1]=Palette32Bit[PaletteIndex+( 1 & (WidePixel>>8))];
		if (!ScanLines)
		{
			YStride-=16;
			YStride+=Xpitch;
...
case 192+16: //BPP=1 Sr=0  2BPP Stretch=1
	...
	{
		WidePixel=WideBuffer[(VidMask & ( Start+(unsigned char)(Hoffset+HorzBeam) ))>>1];
		szSurface32[YStride+=1]=Palette32Bit[PaletteIndex+( 3 & (WidePixel>>6))];
		szSurface32[YStride+=1]=Palette32Bit[PaletteIndex+( 3 & (WidePixel>>4))];
		szSurface32[YStride+=1]=Palette32Bit[PaletteIndex+( 3 & (WidePixel>>2))];
		szSurface32[YStride+=1]=Palette32Bit[PaletteIndex+( 3 & WidePixel)];
		szSurface32[YStride+=1]=Palette32Bit[PaletteIndex+( 3 & (WidePixel>>14))];
		szSurface32[YStride+=1]=Palette32Bit[PaletteIndex+( 3 & (WidePixel>>12))];
		szSurface32[YStride+=1]=Palette32Bit[PaletteIndex+( 3 & (WidePixel>>10))];
		szSurface32[YStride+=1]=Palette32Bit[PaletteIndex+( 3 & (WidePixel>>8))];
		if (!ScanLines)
		{
			YStride-=8;
			YStride+=Xpitch;
...
void GimeGpu::DrawTopBoarder8(SystemState *DTState) const
{
	unsigned short x;
	if (BoarderChange==0)
		return;
...
void GimeGpu::DrawTopBoarder16(SystemState *DTState) const
{
	unsigned short x;
	if (BoarderChange==0)
		return;
...
void GimeGpu::DrawTopBoarder24(SystemState * /*DTState*/) const
{
}

void GimeGpu::DrawTopBoarder32(SystemState *DTState) const
{
...
void GimeGpu::DrawBottomBoarder8(SystemState *DTState) const
{
...
void GimeGpu::DrawBottomBoarder16(SystemState *DTState) const
{
	if (BoarderChange==0) return;
	int ndx = 2 * (LinesperScreen + VertCenter + DTState->LineCounter);
	if (ndx >= DTState->WindowSize.h) return;  // Range check
...
void GimeGpu::DrawBottomBoarder24(SystemState * /*DTState*/) const
{
}

void GimeGpu::DrawBottomBoarder32(SystemState *DTState) const
{
	if (BoarderChange==0) return;
	int ndx = 2 * (LinesperScreen + VertCenter + DTState->LineCounter);
	if (ndx >= DTState->WindowSize.h) return;  // Range check
...
void GimeGpu::TogBlinkState()
{
	BlinkState = BlinkState ^ 1;
}

// These grab the Video info for all COCO 2 modes
void GimeGpu::SetGimeVdgOffset(unsigned char Offset)
{
	if ( CC2Offset != Offset)
	{
		CC2Offset=Offset;
...
void GimeGpu::SetGimeVdgMode(unsigned char VdgMode) //3 bits from SAM Registers
{
...
void GimeGpu::SetGimeVdgMode2(unsigned char Vdgmode2) //5 bits from PIA Register
{
...
void GimeGpu::SetVerticalOffsetRegister(unsigned short Register)
{
...
void GimeGpu::SetGimePalette(unsigned char palette,unsigned char color) 
{
	// Convert the 6bit rgbrgb value to rrrrrggggggbbbbb for the Real video hardware.
	//	unsigned char r,g,b;
	Palette[palette]=color &63;
	Palette8Bit[palette]=PaletteLookup8[MonType][color & 63]; 
	Palette16Bit[palette]=PaletteLookup16[MonType][color & 63];
	Palette32Bit[palette]=PaletteLookup32[MonType][color & 63];
}

bool GimeGpu::CopyPalette(const GimeGpu& other)
{
	auto cmp = memcmp(Palette, other.Palette, sizeof(Palette));
	memcpy(Palette, other.Palette, sizeof(Palette));
	memcpy(Palette8Bit, other.Palette8Bit, sizeof(Palette8Bit));
	memcpy(Palette16Bit, other.Palette16Bit, sizeof(Palette16Bit));
	memcpy(Palette32Bit, other.Palette32Bit, sizeof(Palette32Bit));
	return cmp != 0;
}

void GimeGpu::SetGimeVmode(unsigned char vmode)
{
	if (CC3Vmode != vmode)
	{
		CC3Vmode=vmode;
...
void GimeGpu::SetGimeVres(unsigned char vres)
{
	if (CC3Vres != vres)
	{
		CC3Vres=vres;
...
void GimeGpu::SetGimeHorzOffset(unsigned char data)
{
...
void GimeGpu::SetGimeBoarderColor(unsigned char data)
{
...
void GimeGpu::SetBoarderChange()
{
	if (BoarderChange >0)
		BoarderChange--;
}

void GimeGpu::InvalidateBoarder()
{
	BoarderChange=5;
}

void GimeGpu::SetLinesperScreen(unsigned char Lines)
{
	Lines = (Lines & 3);
...
void GimeGpu::SetupDisplay()
{
	...
	case 1:					//Color Computer 2 Mode
		...
		if (GraphicsMode)
		{
			...
			PaletteIndex=CC2PaletteSet[Temp1];
		}
		else
	...
	BoarderColor16=PaletteLookup16[MonType][CC3BoarderColor & 63];
	BoarderColor32=PaletteLookup32[MonType][CC3BoarderColor & 63];
...
void GimeGpu::SetVidMask(unsigned int data)
{
	VidMask=data;
}

void GimeGpu::SetVideoBank(unsigned char data)
{
...
void GimeGpu::MakeCMPpalette()
{
	...
	for (Index = 0; Index <= 63; Index++)
	{
		...
		gg= (unsigned char)g;
		bb= (unsigned char)b;
		PaletteLookup32[0][Index]= (rr<<16) | (gg<<8) | bb;
		rr=rr>>3;
		gg=gg>>3;
		bb=bb>>3;
		PaletteLookup16[0][Index]= (rr<<11) | (gg<<6) | bb;
		rr=rr>>3;
		gg=gg>>3;
		bb=bb>>3;
		PaletteLookup8[0][Index]=0x80 | ((rr & 2)<<4) | ((gg & 2)<<3) | ((bb & 2)<<2) | ((rr & 1)<<2) | ((gg & 1)<<1) | (bb & 1);
	}
}

unsigned char GimeGpu::SetMonitorType(unsigned char Type)
{
	...
	if (Type != QUERY)
	{
		...
		{
			Palette16Bit[PalNum]=PaletteLookup16[MonType][Palette[PalNum]];
			Palette32Bit[PalNum]=PaletteLookup32[MonType][Palette[PalNum]];
			Palette8Bit[PalNum]= PaletteLookup8[MonType][Palette[PalNum]];
		}
...
unsigned char GimeGpu::SetScanLines(unsigned char Lines)
{
...
int GimeGpu::GetBytesPerRow() const
{
	return BytesperRow;
}

unsigned char GimeGpu::GetHorizontalBorderSize() const
{
	return HorzCenter / 2;
}

unsigned short GimeGpu::GetDisplayedPixelsPerLine() const
{
	return PixelsperLine;
}

unsigned int GimeGpu::GetStartOfVidram() const
{
	return StartofVidram;
}

int GimeGpu::GetGraphicsMode() const
{
	return GraphicsMode;
}

void GimeGpu::FlipArtifacts()
{
...
void GimeGpu::RenderNTSCPixel2x2(Surface32 surface32, size_t surfaceDest, int XpitchDest, char colorIndex, char scanLines) const
{
	colorIndex <<= 1;
...
void GimeGpu::RenderPMODE4NTSC(Surface32 surface32, size_t surfaceDest, int XpitchDest, const unsigned char* cocoSrc, char scanLines) const
{
